...
bool suChannel::isTransmissionChannel() const
{
...
simtime_t suChannel::getTransmissionFinishTime() const
{
...
void suChannel::processMessage(cMessage *msg, simtime_t t, result_t& result)
{
